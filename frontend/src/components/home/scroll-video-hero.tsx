...
const SCENES = [
  {
    ...
    title: ["Australia's", "Wholesale Partner"],
    body: "130+ premium products across 12 categories. Reliable supply, competitive pricing.",
    cta: false,
  ...
  },
  {
    from: 0.28,
    to: 0.52,
    eyebrow: "Premium Beverages",
    title: ["Quality", "In Every Can"],
    body: "Fruit juices, coconut drinks, energy drinks and more — sourced from the finest.",
    cta: false,
    align: "left" as const,
    dark: true,
  },
  {
    from: 0.57,
    to: 0.78,
    eyebrow: "Pure Freshness",
    title: ["Taste the", "Difference"],
    body: "Real fruit ingredients. No shortcuts. Trusted by retailers across Australia.",
    cta: false,
  ...
  },
  {
    ...
    body: "Get wholesale pricing on our full range. Fast dispatch, flexible carton quantities.",
    cta: true,
    align: "center" as const,
    dark: true,
  },
